        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm mt-3">
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <div class="font-semibold bg-gray-800 text-gray-100 py-3 px-6 mb-0">
                        {{ __('Login') }}
                    </div>
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap items-center">
                            <button type="submit" class="bg-gray-800 hover:bg-gray-700 text-gray-100 hover:text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                {{ __('Login') }}
                            </button>
                            ...
                            @endif
                            <p class="w-full text-xs text-center text-gray-700 mt-8 mb-1">
                                <a href="{{ route('guestCheckout.index') }}" class="bg-gray-800 hover:bg-gray-700 text-gray-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Checkout as guest</a>
                            </p>
                        </div>
                    </form>
